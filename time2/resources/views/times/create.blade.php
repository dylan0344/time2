...
<div class="row">
    <div class="col-sm-12 shadow-lg p-3 mb-5 bg-white rounded">
        <h1 class="display">Add time</h1>
        <a style="margin: 19px; float: right;" href="{{ route('times.index')}}" class="btn btn-danger"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-backspace-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
